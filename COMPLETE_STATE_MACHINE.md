...
7. [Monitor Behavior](#monitor-behavior)
8. [Layout Algorithm](#layout-algorithm)
9. [Geometry Management](#geometry-management)
10. [Event Loop](#event-loop)
11. [Floating Windows](#floating-windows)
12. [Drag Operations](#drag-operations)
13. [Focus System](#focus-system)
14. [WM_TAKE_FOCUS Protocol](#wm_take_focus-protocol)
15. [ICCCM Compliance](#icccm-compliance)
16. [EWMH Protocol](#ewmh-protocol)
17. [Configuration](#configuration)
18. [Special Behaviors](#special-behaviors)
...
- **State modifiers**: Flags that apply to VISIBLE windows to modify their behavior or appearance: fullscreen, above, below, sticky, modal, maximized_horz, maximized_vert, shaded, skip_taskbar, skip_pager, demands_attention.
...
- hide_window() returns early for sticky windows, so they remain visible
- Clears focus
