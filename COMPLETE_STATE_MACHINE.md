...
9. [Interaction Modes](#interaction-modes)
10. [Geometry Management](#geometry-management)
11. [Layout Algorithm](#layout-algorithm)
12. [Floating Windows](#floating-windows)
13. [Drag Operations](#drag-operations)
...
- Desktop windows: LWM never calls hide_window/show_window() on them, so hidden flag is never set. Desktop windows are always positioned as background windows below all others
